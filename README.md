## Cisco DevNet Learning Labs: Virtual Internet Routing Labs (VIRL)
...
You can write Markdown in a plain text editor, and desktop and Web-based options let you write and preview your work at the same time. We recommend Visual Studio Code [Download](https://code.visualstudio.com/) for these reasons:
